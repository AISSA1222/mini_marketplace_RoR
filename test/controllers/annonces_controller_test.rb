...
class AnnoncesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create annonce" do
    assert_difference("Annonce.count") do
      post annonces_url, params: { annonce: { category: @annonce.category, city: @annonce.city, date: @annonce.date, prix: @annonce.prix, titre: @annonce.titre } }
    end
  ...
  test "should update annonce" do
    patch annonce_url(@annonce), params: { annonce: { category: @annonce.category, city: @annonce.city, date: @annonce.date, prix: @annonce.prix, titre: @annonce.titre } }
